...
call s:h("NonText",   {"fg": s:purple,  "bg": s:light_bg}) " end file
...
call s:h("Folded",     {"fg": s:light_fg, "bg": s:purple})

" Search
call s:h("Search",    {"fg": s:light_fg, "bg": s:magenta, "gui": "bold,underline", "cterm": "bold,underline"})
...
call s:h("Comment",        {"fg": s:dark_sky,        "gui": "italic"               })
call s:h("SpecialComment", {"fg": s:sky,             "gui": "bold", "cterm": "bold"})
" Doxygen colors
